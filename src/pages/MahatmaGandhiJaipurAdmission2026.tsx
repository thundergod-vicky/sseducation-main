...
const college: CollegeData = {
  ...
  getEligibilityAnalysis: (score, _cat) => {
    if (score >= 580) {
      ...
      return {
        ...
        text: "You have qualified NEET UG. Pathway choices rely on NRI-sponsored streams or stray vacancy counseling rounds.",
  ...
  feeNotes: [
    ...
    "<strong>Security Deposit:</strong> A one-time refundable security deposit of ₹2,00,005 is required at admission.",
